...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
			...
			// uncomment this line to test with a local file
		    //earthquakesURL = "2.5_week.atom";
		}
		MapUtils.createDefaultEventDispatcher(this, map);
		
		// FOR TESTING: Set earthquakesURL to be one of the testing files by uncommenting
		// one of the lines below.  This will work for both online and offline mode
	    ...
	    // Add markers to map
	    // Country markers are not added to the map.  They are used
	...
	// It will loop through the country markers or country features
